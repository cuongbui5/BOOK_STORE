        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageCover = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAdresses", x => new { x.UserId, x.AddressId });
                    table.ForeignKey(
                        name: "FK_UserAdresses_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetails", x => new { x.ShopOrderId, x.CartItemId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_ShopOrders_ShopOrderId",
